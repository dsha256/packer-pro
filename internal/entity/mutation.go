...
func (m *SizeMutation) SetID(id int) {
	m.id = &id
}
...
func (m *SizeMutation) SetSize(i int) {
	m.size = &i
	m.addsize = nil
}

// Size returns the value of the "size" field in the mutation.
func (m *SizeMutation) Size() (r int, exists bool) {
	v := m.size
	if v == nil {
		return
	}
...
func (m *SizeMutation) OldSize(ctx context.Context) (v int, err error) {
...
func (m *SizeMutation) AddSize(i int) {
	if m.addsize != nil {
		*m.addsize += i
	} else {
		m.addsize = &i
...
func (m *SizeMutation) AddedSize() (r int, exists bool) {
	v := m.addsize
	if v == nil {
		return
	}
