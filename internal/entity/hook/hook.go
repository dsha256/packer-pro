...
type SizeFunc func(context.Context, *entity.SizeMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f SizeFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	if mv, ok := m.(*entity.SizeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.SizeMutation", m)
}
