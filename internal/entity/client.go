...
import (
	...
	"github.com/dsha256/packer-pro/internal/entity/migrate"
...
func (c *SizeClient) mutate(ctx context.Context, m *SizeMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entity: unknown Size mutation op: %q", m.Op())
	}
}
